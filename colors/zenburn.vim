...
hi Function        guifg=#efef8f                              ctermfg=223
hi Identifier      guifg=#efdcbc                              ctermfg=223 cterm=none
hi IncSearch       guifg=#f8f893 guibg=#385f38                ctermfg=228 ctermbg=23
hi Keyword         guifg=#f0dfaf gui=bold                     ctermfg=223 cterm=none
hi Macro           guifg=#ffcfaf gui=bold                     ctermfg=223 cterm=none
...
hi StatusLine      guifg=#313633 guibg=#ccdc90                ctermfg=240 ctermbg=255
hi StatusLineNC    guifg=#2e3330 guibg=#88b090                ctermfg=242 ctermbg=188
...
"hi VertSplit       guifg=#2e3330 guibg=#688060                ctermfg=242 ctermbg=65
...
if exists("g:zenburn_high_Contrast") && g:zenburn_high_Contrast
    ...
    hi Normal        guifg=#dcdccc guibg=#1f1f1f           ctermfg=188 ctermbg=237
    ...
    hi LineNr        guifg=#9fafaf guibg=#161616           ctermfg=248 ctermbg=235
    ...
    hi Normal        guifg=#dcdccc guibg=#3f3f3f           ctermfg=255 ctermbg=500
    ...
    hi LineNr        guifg=#9fafaf guibg=#262626           ctermfg=248 ctermbg=238
